...
This project was created entirely from scratch by me, with zero prior coding experience, using natural language commands with Gemini CLI.
...
TeleFileDB is a tool designed to organize and search files saved in Telegram.
It transforms Telegram channels or groups into a fast-searchable, easy-to-manage personal file index database, freeing your files from cluttered conversations so you can quickly find every important document.
